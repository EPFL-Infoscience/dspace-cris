...
public class OpenPolicyFinderDataProviderTest extends AbstractDSpaceTest {
    ...
    public void setUp() {
        ...
        opfJournalIssnProvider = externalDataService.getExternalDataProvider("opfJournalIssn");
    }
     ...
     */
    @Test
    @Ignore("This test is currently ignored since the equals method for ExternalDataObject is not yet implemented, " +
            "but should be enabled once it is")
